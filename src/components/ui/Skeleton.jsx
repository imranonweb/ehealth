export function Skeleton({ width, height = 16, radius = 'var(--r-sm)', className = '', style = {} }) {
  return (
    <div
  ...
  return (
    <div className="card" style={{ padding: 'var(--sp-6)' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
        <Skeleton width={44} height={44} radius="var(--r-lg)" />
        <div style={{ flex: 1 }}>
      ...
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="card" style={{ padding: 'var(--sp-5)' }}>
          <div style={{ display: 'flex', gap: 16, alignItems: 'flex-start' }}>
            <Skeleton width={42} height={42} radius="var(--r-md)" />
            <div style={{ flex: 1 }}>
