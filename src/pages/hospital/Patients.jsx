            ...
            <table className="table" style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead className="table-header">
                <tr>
                  ...
                  <th className="table-head" style={{ padding: '14px 20px' }}>Contact Information</th>
                  <th className="table-head" style={{ padding: '14px 20px' }}>Gender</th>
                ...
                {results.map((p) => {
                  ...
                  return (
                    <tr key={p.id} className="table-row" style={{ transition: 'background-color 0.15s ease' }}>
                      ...
                      <td className="table-cell" style={{ padding: '18px 20px', textTransform: 'capitalize', color: 'var(--text-secondary)' }}>
                        {p.gender || '—'}
                      </td>
