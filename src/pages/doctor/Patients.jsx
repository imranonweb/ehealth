  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="page-header" style={{ marginBottom: 'var(--sp-6)' }}>
        <div>
          <h1 className="page-title">Patient Directory & Record Lookup</h1>
          <p className="page-sub">
            Search patients to review longitudinal medical history, prior diagnoses, and lab results.
          </p>
        </div>
      </div>
      ...
      <div className="card" style={{ padding: 'var(--sp-6)', marginBottom: 'var(--sp-6)' }}>
        ...
        <p className="field-hint" style={{ marginTop: 8 }}>
          Live search queries all authorized patient profiles across the E-Health registry.
        </p>
      </div>
      ...
      <div className="card" style={{ padding: 'var(--sp-6)' }}>
        ...
        {results.length === 0 && !loading && (
          <EmptyState
            ...
            description={query.length >= 2 ? "No registered patient matched your search query." : "Enter at least 2 characters to search the national patient index."}
          />
        )}
